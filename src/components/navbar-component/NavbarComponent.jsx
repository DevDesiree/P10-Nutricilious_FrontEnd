...
<nav className="bg-black border-black-200 dark:bg-black-900">
  ...
  <div className="flex justify-between items-center ">
      ...
      <button type="button" className="text-black bg-amber-400 hover:bg-amber-400 focus:ring-4 focus:outline-none focus:ring-amber-400 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-amber-100 dark:hover:bg-amber-400 dark:focus:ring-amber-400">Log In</button>
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-black-100 rounded-lg bg-black-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-black dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
        <a href="#" className="block py-2 px-3 md:p-0 text-amber-400 bg-amber-400 rounded md:bg-transparent md:text-white md:dark:text-amber-400" aria-current="page">Alimentos veganos y saludables</a>
      </li>
      <li>
      ...
      <li>
        <a href="#" className="block py-2 px-3 md:p-0 text-white rounded hover:bg-amber-400 md:hover:bg-transparent md:hover:text-amber-400 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Snacks saludables</a>
      </li>
      <li>
      ...
      <li>
        <a href="#" className="block py-2 px-3 md:p-0 text-white rounded hover:bg-amber-400 md:hover:bg-transparent md:hover:text-amber-400 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Aceites y condimentos saludables</a>
      </li>
    </ul>
  </div>
  </div>
