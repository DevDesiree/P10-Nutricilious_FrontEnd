...
<nav className="bg-black border-black-200 dark:bg-black-900">
  ...
  <div className="flex-row justify-between space-x-5">
      ...
      <button type="button" className="text-black bg-amber-400 hover:bg-amber-400 focus:ring-4 focus:outline-none focus:ring-amber-400 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-amber-100 dark:hover:bg-amber-400 dark:focus:ring-amber-400">Registrarse</button>
